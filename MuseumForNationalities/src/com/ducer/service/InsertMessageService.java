...
public class InsertMessageService {
	...
	public static boolean insertMeassge(String insrtUrlStr,
			String messageTableName, String string) throws ClientProtocolException, IOException {
		HttpPost request = new HttpPost(insrtUrlStr);
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("messageTable",
				messageTableName));
